...
const translations = {
  en: {
    ...
    vadListening: 'VAD listening (always-on)',
    vadSpeechDetected: 'Speech detected — transcribing segment…',
    vadProcessingSegment: 'Processing speech segment…',
    ...
    vadRecordingInProgress: '\ud83c\udfa4 Always-on recording enabled. Silero VAD triggers transcription only when speech is detected.',
    recordingPausedMsg: '\u23f8 Recording paused. Click "Resume" to continue or "Stop" to finish.',
    vadStatusLabel: 'VAD',
    vadState_idle: 'idle',
    vadState_loading: 'loading',
    vadState_listening: 'listening',
    vadState_speech: 'speech',
    vadState_processing: 'processing',
    vadState_error: 'error',
    vadSpeechProbability: 'speech prob.',
    vadSegmentsDetected: 'segments',
    vadQueueLabel: 'transcription queue',
    vadQueueSegment: 'Segment',
    vadQueueQueued: 'queued',
    vadQueueProcessing: 'transcribing',
    vadQueueEmpty: 'No pending transcriptions',
    vadCurrentSegmentLabel: 'Current segment',
    vadListeningForSpeech: 'Waiting for speech',
    vadEndingIn: 'Ending in {time}',
    vadEndingSegment: 'Ending segment…',
    vadTranscribedIn: 'transcribed in {time}',
    vadQueueCompletedLabel: 'Completed snippets',
    vadRetrySegment: 'Re-run segment transcription',
    vadQueueWaitingDetail: 'Waiting to transcribe with current Parakeet settings.',
    vadNoTranscript: 'No transcript returned for this segment.',
    ...
    // Tooltips
    tooltipBackend: 'WASM (CPU) is the default and the most compatible. WebGPU uses the GPU when available and still falls back to CPU/WASM work as needed. Use WebGPU when you want to trade longer model startup for lower CPU during transcription.',
    ...
    tooltipCpuThreads: 'Number of CPU threads to use for Parakeet WASM work. More threads = faster, but higher CPU load. Recommended: leave a couple of cores free for the browser. Default: hardware cores minus 2, capped at 4.',
    ...
    delete: '\ud83d\uddd1\ufe0f Delete',
    reviewNavigation: 'Recorder and review tabs',
    recordPage: 'Recorder',
    reviewPage: 'Review',
    reviewPageHint: 'Edit saved snippets, replay session audio when available, and merge multiple snippets into one paragraph.',
    reviewMergeSelected: 'Merge selected',
    reviewSelectedCount: '{count} snippet(s) selected for merge.',
    reviewEmptyTitle: 'No saved snippets yet',
    reviewEmptyBody: 'Run a transcription first, then review, edit, merge, or delete it here.',
    reviewSnippet: 'Snippet',
    reviewMergedSnippet: 'Merged snippet',
    reviewWords: 'words',
    reviewMergedCount: 'merged from {count} snippets',
    reviewClip: 'Clip',
    reviewAudioUnavailable: 'Audio is not available for this snippet in the current session.',
    reviewEditTranscript: 'Edit transcript text',
  ...
  fr: {
    ...
    vadListening: 'VAD en \u00e9coute (toujours actif)',
    vadSpeechDetected: 'Parole d\u00e9tect\u00e9e — transcription du segment…',
    vadProcessingSegment: 'Traitement du segment vocal…',
    ...
    vadRecordingInProgress: '\ud83c\udfa4 Enregistrement permanent activ\u00e9. Silero VAD lance la transcription seulement quand la parole est d\u00e9tect\u00e9e.',
    recordingPausedMsg: '\u23f8 Enregistrement en pause. Cliquez "Reprendre" pour continuer ou "Stop" pour terminer.',
    vadStatusLabel: 'VAD',
    vadState_idle: 'inactif',
    vadState_loading: 'chargement',
    vadState_listening: '\u00e9coute',
    vadState_speech: 'parole',
    vadState_processing: 'traitement',
    vadState_error: 'erreur',
    vadSpeechProbability: 'prob. parole',
    vadSegmentsDetected: 'segments',
    vadQueueLabel: 'file de transcription',
    vadQueueSegment: 'Segment',
    vadQueueQueued: 'en file',
    vadQueueProcessing: 'transcription',
    vadQueueEmpty: 'Aucune transcription en attente',
    vadCurrentSegmentLabel: 'Segment en cours',
    vadListeningForSpeech: 'En attente de parole',
    vadEndingIn: 'Fin dans {time}',
    vadEndingSegment: 'Fin du segment…',
    vadTranscribedIn: 'transcrit en {time}',
    vadQueueCompletedLabel: 'Extraits terminés',
    vadRetrySegment: 'Relancer la transcription du segment',
    vadQueueWaitingDetail: 'En attente de transcription avec les paramètres Parakeet actuels.',
    vadNoTranscript: 'Aucune transcription retournée pour ce segment.',
    ...
    // Tooltips
    tooltipBackend: "WASM (CPU) est le choix par défaut et le plus compatible. WebGPU utilise le GPU quand il est disponible et retombe sur du calcul CPU/WASM si nécessaire. Utilisez WebGPU si vous acceptez un démarrage plus long du modèle pour réduire l'usage CPU pendant la transcription.",
    ...
    tooltipCpuThreads: "Nombre de threads CPU à utiliser pour le travail WASM de Parakeet. Plus de threads = plus rapide, mais plus de charge CPU. Recommandé : laisser quelques cœurs libres pour le navigateur. Défaut : nombre de cœurs matériels moins 2, plafonné à 4.",
    ...
    delete: '\ud83d\uddd1\ufe0f Supprimer',
    reviewNavigation: 'Onglets enregistrement et relecture',
    recordPage: 'Enregistrer',
    reviewPage: 'Relecture',
    reviewPageHint: 'Modifiez les extraits enregistr\u00e9s, relisez l\u2019audio encore disponible dans cette session et fusionnez plusieurs extraits en un seul paragraphe.',
    reviewMergeSelected: 'Fusionner la s\u00e9lection',
    reviewSelectedCount: '{count} extrait(s) s\u00e9lectionn\u00e9(s) pour la fusion.',
    reviewEmptyTitle: 'Aucun extrait enregistr\u00e9 pour le moment',
    reviewEmptyBody: 'Lancez d\u2019abord une transcription, puis revenez ici pour la relire, la modifier, la fusionner ou la supprimer.',
    reviewSnippet: 'Extrait',
    reviewMergedSnippet: 'Extrait fusionn\u00e9',
    reviewWords: 'mots',
    reviewMergedCount: 'fusion de {count} extraits',
    reviewClip: 'Clip',
    reviewAudioUnavailable: 'Le son n\u2019est pas disponible pour cet extrait dans la session en cours.',
    reviewEditTranscript: 'Modifier le texte transcrit',
    reviewConfirmDelete: 'Confirmer',
